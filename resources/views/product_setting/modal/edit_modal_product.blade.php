            ...
            <form id="editProductForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mt-2 d-flex flex-wrap gap-2" id="edit_foto_lainnya_preview">
                            <input type="file" id="edit_foto_lainnya" name="foto_lainnya[]" multiple
                                accept="image/*">
                            <div id="edit_foto_lainnya_preview" class="mt-2 d-flex flex-wrap gap-2"></div>
...
<script>
    ...
    function fillEditProductModal(product) {
        ...
        if (product.foto_lainnya) {
            try {
                const fotoArray = JSON.parse(product.foto_lainnya); // format json dari blade
