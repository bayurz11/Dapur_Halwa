                    ...
                    <div class="card-body p-24">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-edit-profile" role="tabpanel"
                                ...
                                <div class="mb-24 mt-16">
                                    <div class="avatar-upload position-relative">
                                        ...
                                        <div class="avatar-preview">
                                            <div id="imagePreview"
                                                style="width: 150px; height: 150px; border-radius: 50%; background-size: cover; background-position: center; background-image: url('{{ $user->photo ? asset('storage/' . $user->photo) : asset('assets/images/user-grid/default.png') }}');">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <form action="{{ route('profile_setting.update') }}" method="POST"
                            ...
                            <div class="tab-pane fade" id="pills-change-passwork" role="tabpanel"
                                ...
                                <form action="{{ route('profile_setting.change_password') }}" method="POST">
                                    @csrf
