                             ...
                             <a class="d-flex flex-column flex-sm-row align-items-sm-center" href="post.html">
                                 <span class="media">
                                     <picture>
                                         <source data-srcset="{{ asset('assets_fe/img/placeholder.jpg') }}"
                                             srcset="{{ asset('assets_fe/img/placeholder.jpg') }}" type="image/webp" />
                                         <img class="preview" data-src="{{ asset('assets_fe/img/placeholder.jpg') }}"
                                             src="{{ asset('assets_fe/img/placeholder.jpg') }}" alt="post" />
                                     </picture>
                                 </span>
                                 <span class="wrapper">
                 ...
                 <div class="widgets-item widgets-item--sale">
                     ...
                     <div class="media">
                         <picture>
                             <source data-srcset="{{ asset('assets_fe/img/placeholder.jpg') }}"
                                 srcset="{{ asset('assets_fe/img/placeholder.jpg') }}" type="image/webp" />
                             <img class="lazy leaf" data-src="{{ asset('assets_fe/img/placeholder.jpg') }}"
                                 src="{{ asset('assets_fe/img/placeholder.jpg') }}" alt="media" />
                         </picture>
                     </div>
                 </div>
