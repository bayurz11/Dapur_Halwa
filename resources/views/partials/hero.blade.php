<section class="hero section">
        ...
        <div class="hero_content col-xl-6">
            <div class="hero_content-header">
                <h1 id="hero-title" class="hero_content-header_title" data-aos="fade-right">
                    {{ __('messages.hero content header title') }}
                </h1>
                <p id="hero-description" class="hero_content-header_text" data-aos="fade-right">
                    {{ __('messages.hero content header description') }}.
                </p>
            </div>

            <a class="hero_content-btn btn" data-aos="fade-up"
                href="{{ route('products') }}">{{ __('messages.cte-btn') }}</a>
    ...
    <div class="hero_media" data-aos="fade-left" data-aos-delay="300">
        <picture>
            <source data-srcset="{{ asset('assets_fe/img/66753 1.png') }}"
                srcset="{{ asset('assets_fe/img/66753 1.png') }}" type="image/webp" />
            <img class="lazy hero_media-leaf" data-src="{{ asset('assets_fe/img/66753 1.png') }}"
                src="{{ asset('assets_fe/img/66753 1.png') }}" alt="media" />
        </picture>
    </div>
</section>
