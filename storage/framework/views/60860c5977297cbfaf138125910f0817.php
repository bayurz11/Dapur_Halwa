...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row gy-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6 col-xs-6">
                                    <div class="radius-8 h-100 text-center p-20 bg-info-focus">
                                        ...
                                        <h6 class="mb-0 mt-4"><?php echo e($totalVisitors); ?></h6>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xs-6">
                                    <div class="radius-8 h-100 text-center p-20 bg-lilac-100">
                                        ...
                                        <h6 class="mb-0 mt-4"><?php echo e($todayVisitors); ?></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <?php $__env->startPush('scripts'); ?>
            ...
            <script>
                const markers = <?php echo json_encode($markers, 15, 512) ?>;
...
<?php echo $__env->make('partials.maindashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\bayur\OneDrive\Desktop\Dapur_Halwa\resources\views/dashboard/index.blade.php ENDPATH**/ ?>