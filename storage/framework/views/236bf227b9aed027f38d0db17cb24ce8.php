 <?php $__env->startSection('title', 'Dapur Halwa | Tentang Kami'); ?>
                         ...
                         <div class="media">
                             <picture>
                                 <source data-srcset="<?php echo e(asset('assets_fe/img/placeholder.jpg')); ?>"
                                     srcset="<?php echo e(asset('assets_fe/img/placeholder.jpg')); ?>" type="image/webp" />
                                 <img class="lazy" data-src="<?php echo e(asset('assets_fe/img/placeholder.jpg')); ?>"
                                     src="<?php echo e(asset('assets_fe/img/placeholder.jpg')); ?>"
...
<?php echo $__env->make('partials.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\bayur\OneDrive\Desktop\Dapur_Halwa\resources\views/about.blade.php ENDPATH**/ ?>