<section class="hero section">
    <div class="container">
        <div class="hero_content col-xl-6">
            <div class="hero_content-header">
                <h1 id="hero-title" class="hero_content-header_title" data-aos="fade-right">
                    <?php echo e(__('messages.hero content header title')); ?>

                </h1>
                <p id="hero-description" class="hero_content-header_text" data-aos="fade-right">
                    <?php echo e(__('messages.hero content header description')); ?>.
                </p>
            </div>

            <a class="hero_content-btn btn" data-aos="fade-up"
                href="<?php echo e(route('products')); ?>"><?php echo e(__('messages.cte-btn')); ?></a>
            <div class="features-list d-sm-flex flex-wrap">
                    ...
                    <div class="features-list_item" data-order="1" data-aos="fade-up">
                        <div class="wrapper d-flex flex-column flex-sm-row align-items-center">
                            <span class="icon d-flex align-items-center justify-content-center">
                                <svg class="" width="50" height="35" viewBox="0 0 50 35" fill="none"
                                    ...
                                    <path
                                        ...
                                        fill="currentColor" />
                                    <rect x="21.4277" y="25.5103" width="11.2245" height="4.08163"
                                        fill="currentColor" />
                                    <path
                ...
                <div class="features-list_row d-sm-flex">
                    <div class="features-list_item" data-order="3" data-aos="fade-up">
                        <div class="wrapper d-flex flex-column flex-sm-row align-items-center">
                            <span class="icon d-flex align-items-center justify-content-center">
                                <svg class="" width="50" height="44" viewBox="0 0 50 44" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <div class="features-list_item" data-order="4" data-aos="fade-up">
                        <div class="wrapper d-flex flex-column flex-sm-row align-items-center">
                            <span class="icon d-flex align-items-center justify-content-center">
                                <svg class="" width="47" height="50" viewBox="0 0 47 50" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
    ...
    <div class="hero_media" data-aos="fade-left" data-aos-delay="300">
        <picture>
            <source data-srcset="<?php echo e(asset('assets_fe/img/66753 1.png')); ?>"
                srcset="<?php echo e(asset('assets_fe/img/66753 1.png')); ?>" type="image/webp" />
            <img class="lazy hero_media-leaf" data-src="<?php echo e(asset('assets_fe/img/66753 1.png')); ?>"
                src="<?php echo e(asset('assets_fe/img/66753 1.png')); ?>" alt="media" />
        </picture>
    </div>
</section>
<?php /**PATH C:\Users\bayur\OneDrive\Desktop\Dapur_Halwa\resources\views/partials/hero.blade.php ENDPATH**/ ?>