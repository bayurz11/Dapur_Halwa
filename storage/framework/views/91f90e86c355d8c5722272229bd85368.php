 <?php $__env->startSection('title', 'Dapur Halwa | Galeri'); ?>
 <?php $page = 'Galeri'; ?>
             ...
             <div class="news_wrapper">
                 <ul class="news_list">
                     <li class="news_list-item">
                         ...
                         <div class="main">
                             ...
                             <p class="main_text">
                                 Sed sed risus pretium quam vulputate dignissim suspendisse in. Sociis natoque penatibus et
                                 magnis dis
                                 parturient. Libero enim sed faucibus turpis. Curabitur gravida arcu ac tortor dignissim
                                 convallis
                 ...
                 <ul class="pagination d-flex align-items-center">
                     <li class="pagination-page">
                         <a class="pagination-page_link d-flex align-items-center justify-content-center" href="#"
                             data-current="true">1</a>
                     </li>
                     <li class="pagination-page">
                             ...
                             <a class="d-flex flex-column flex-sm-row align-items-sm-center" href="post.html">
                                 <span class="media">
                                     <picture>
                                         <source data-srcset="<?php echo e(asset('assets_fe/img/placeholder.jpg')); ?>"
                                             srcset="<?php echo e(asset('assets_fe/img/placeholder.jpg')); ?>" type="image/webp" />
                                         <img class="preview" data-src="<?php echo e(asset('assets_fe/img/placeholder.jpg')); ?>"
                                             src="<?php echo e(asset('assets_fe/img/placeholder.jpg')); ?>" alt="post" />
                                     </picture>
                                 </span>
                                 <span class="wrapper">
                                     <span class="title">Best Weed Strains For Anxiety</span>
                                     <span class="metadata d-flex align-items-center"><i
                                             class="icon-calendar_day icon"></i>September 30, 2021</span>
                                 </span>
                             </a>
                         </li>
                         <li class="list-item">
                 ...
                 <div class="widgets-item widgets-item--sale">
                     ...
                     <div class="media">
                         <picture>
                             <source data-srcset="<?php echo e(asset('assets_fe/img/placeholder.jpg')); ?>"
                                 srcset="<?php echo e(asset('assets_fe/img/placeholder.jpg')); ?>" type="image/webp" />
                             <img class="lazy leaf" data-src="<?php echo e(asset('assets_fe/img/placeholder.jpg')); ?>"
                                 src="<?php echo e(asset('assets_fe/img/placeholder.jpg')); ?>" alt="media" />
                         </picture>
                     </div>
                 </div>
...
<?php echo $__env->make('partials.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\bayur\OneDrive\Desktop\Dapur_Halwa\resources\views/articles.blade.php ENDPATH**/ ?>