                     ...
                     <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                         <li class="news_list-item">
                             <div class="media">
                                 ...
                                 <picture>
                                     <source data-srcset="<?php echo e($thumbnailPath); ?>" srcset="<?php echo e($thumbnailPath); ?>"
                                         type="image/webp" />
                                     <img class="lazy" data-src="<?php echo e($thumbnailPath); ?>" src="<?php echo e($thumbnailPath); ?>"
                                         alt="Thumbnail <?php echo e($article->title); ?>" />
                                 </picture>
                             ...
                             <div class="main">
                                 ...
                                 <h4 class="main_title"><?php echo e($article->title); ?></h4>
                                 <p class="main_text">
                                 ...
                                 <a class="d-flex flex-column flex-sm-row align-items-sm-center" href="post.html">
                                     <span class="media">
                                         <picture>
                                             <source data-srcset="<?php echo e($thumbnailPath); ?>" srcset="<?php echo e($thumbnailPath); ?>"
                                                 type="image/webp" />
                                             <img class="preview" data-src="<?php echo e($thumbnailPath); ?>"
                                                 src="<?php echo e($thumbnailPath); ?>" alt="post" />
                                         </picture>
                                     </span>
                                     <span class="wrapper">
                                         <span class="title"><?php echo e($article->title); ?></span>
                                         <span class="metadata d-flex align-items-center"><i
                                                 class="icon-calendar_day icon"></i><?php echo e($article->created_at->format('F j, Y')); ?></span>
                                     </span>
                                 </a>
                             </li>
                         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
