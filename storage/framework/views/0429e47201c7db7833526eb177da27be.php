                            ...
                            <a class="link" href="#" target="_blank" rel="noopener norefferer">
                                <picture>
                                    ...
                                    <img class="lazy preview" data-src="<?php echo e(asset('assets_fe/img/placeholder.jpg')); ?>"
                                        src="<?php echo e(asset('assets_fe/img/placeholder.jpg')); ?>" alt="instagram post" />
                                </picture>
                            </a>
                        </li>
                    <?php endfor; ?>
    ...
    <div class="footer_secondary mt-4">
        <div
            ...
            <ul class="footer_secondary-list d-flex justify-content-center align-items-center gap-2 mb-2 mb-md-0">
                <li class="list-item">
                    <a class="link d-flex align-items-center gap-2" href="<?php echo e(url('/lang/id')); ?>">
                ...
                <li class="list-item">
                    <a class="link d-flex align-items-center gap-2" href="<?php echo e(url('/lang/en')); ?>">
...
<?php /**PATH C:\Users\bayur\OneDrive\Desktop\Dapur_Halwa\resources\views/partials/footer.blade.php ENDPATH**/ ?>