        ...
        <div class="header_user d-flex justify-content-end align-items-center">
            <form class="header_user-search" id="productSearchFormhead" onsubmit="return false;">
                <input class="header_user-search_field field required" name="search" type="text"
                    value="<?php echo e(request('search')); ?>" placeholder="<?php echo e(__('messages.Search placeholder')); ?>" />
                            ...
                            <ul class="dropdown-list">
                                ...
                                <li class="list-item nav-item">
                                    <a class="dropdown-item d-flex align-items-center" href="<?php echo e(url('/lang/en')); ?>">
                                        <img src="<?php echo e(asset('assets/images/flags/united-kingdom.png')); ?>"
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        searchButton.addEventListener('click', function(e) {
            ...
            if (query.length > 0) {
                const url = "<?php echo e(route('products')); ?>" + "?search=" + encodeURIComponent(query);
